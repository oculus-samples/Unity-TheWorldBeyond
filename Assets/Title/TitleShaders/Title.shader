			...
			SubShader
		{
			...
			Pass
			{
				...
				fixed4 frag(vertexOutput i) : SV_Target
				{
					...
					half distanceRipple = sin(distanceToOz * 2 + (_Time.y + _Time.x)) * 0.5 + 0.6;
					...
					half4 animatedStarTextures = starTextures.rrrr   * ((noisyMask * 0.85) + (distanceRipple * _OzRippleStrength));
