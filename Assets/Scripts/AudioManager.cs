...
public class AudioManager : MonoBehaviour
{
    ...
    public int TransitionTimeToOzExploresReality = 1;
    public AudioMixerSnapshot[] OzExploresReality;
    ...
    public static void SetSnapshot_OzExploresReality()
    {
        Instance._audioMixer.SetFloat("OccAmbVol", 0f);
        Instance._audioMixer.TransitionToSnapshots(Instance.OzExploresReality,_weights, Instance.TransitionTimeToOzExploresReality);
    }
