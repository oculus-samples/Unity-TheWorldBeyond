...
public class VirtualFlashlight : SanctuaryToy
{
    ...
    void LateUpdate()
    {
        ...
        {
            Quaternion quadLook = Quaternion.LookRotation(_lightQuads[i].transform.position - SanctuaryExperience.Instance._mainCamera.transform.position);
        ...
        float rotationOffset = SanctuaryExperience.Instance._usingHands ? 0.0f : -0.03f;
        ...
        {
            SanctuaryExperience.Instance.AbsorbDebris(transform.position);
        }
    }
    ...
    public override void Deactivate()
    {
        ...
        if (!SanctuaryExperience.Instance._usingHands)
        {
            OVRInput.SetControllerVibration(1, 0, SanctuaryExperience.Instance._gameController);
        }
    }
    ...
    public override void Action()
    {
        if (!SanctuaryExperience.Instance._usingHands)
        {
            OVRInput.SetControllerVibration(1, 0.5f, SanctuaryExperience.Instance._gameController);
        }
    }
