...
public class RoomFramer : SanctuaryToy
{
    static public RoomFramer Instance = null;

    SanctuaryRoomObject _hoveredSurface = null;
    ...
    private void Update()
    {
        ...
        SanctuaryRoomObject lastSurface = _hoveredSurface;
        ...
        SanctuaryExperience.Instance.RepelDebris(_hoveredPoint);
    }
    ...
    public override void ActionUp()
    {
        ...
        {
            SanctuaryRoomObject clickedWall = _hoveredSurface.GetComponent<SanctuaryRoomObject>();
            ...
            {
                SanctuaryExperience.Instance.OpenedWall(surfaceId);
                SanctuaryTutorial.Instance.HideMessage(SanctuaryTutorial.TutorialMessage.ShootWall);
            }
            ...
            SanctuaryEnvironment.Instance.SetOutdoorAudioParams(audioPos, audioOn);
