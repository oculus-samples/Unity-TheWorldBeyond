...
#if OVR_INTERNAL_CODE
	private static void ApplyInternalFeatureManifestFlags(XmlDocument doc, string androidNamespaceURI, bool modifyIfFound)
	{
		//============================================================================
		// Body Tracking
		// If Quest is the target device, add the bodytracking manifest tags if needed
		OVRProjectConfig.BodyTrackingSupport targetBodyTrackingSupport = OVRProjectConfig.GetProjectConfig().bodyTrackingSupport;
		bool bodyTrackingEntryNeeded = OVRDeviceSelector.isTargetDeviceQuestFamily && (targetBodyTrackingSupport == OVRProjectConfig.BodyTrackingSupport.Enabled);

		AddOrRemoveTag(doc,
			androidNamespaceURI,
			"/manifest",
			"uses-feature",
			"com.oculus.feature.BODY_TRACKING",
		...
		//============================================================================
		// Face Tracking
		OVRProjectConfig.FaceTrackingSupport targetFaceTrackingSupport = OVRProjectConfig.GetProjectConfig().faceTrackingSupport;
		bool faceTrackingEntryNeeded = OVRDeviceSelector.isTargetDeviceQuestFamily && (targetFaceTrackingSupport == OVRProjectConfig.FaceTrackingSupport.Enabled);
		...
		//============================================================================
		// Eye Tracking
		OVRProjectConfig.EyeTrackingSupport targetEyeTrackingSupport = OVRProjectConfig.GetProjectConfig().eyeTrackingSupport;
		bool eyeTrackingEntryNeeded = OVRDeviceSelector.isTargetDeviceQuestFamily && (targetEyeTrackingSupport == OVRProjectConfig.EyeTrackingSupport.Enabled);
		...
		//============================================================================
		// Touch Controller Pro
		OVRProjectConfig.TouchControllerProSupport touchControllerProSupport = OVRProjectConfig.GetProjectConfig().touchControllerProSupport;
		bool touchControllerProEntryNeeded = OVRDeviceSelector.isTargetDeviceQuestFamily && (touchControllerProSupport == OVRProjectConfig.TouchControllerProSupport.Enabled);

		AddOrRemoveTag(doc,
			androidNamespaceURI,
			"/manifest",
			"uses-feature",
			"oculus.software.touch_controller_pro",
			touchControllerProEntryNeeded,
			modifyIfFound,
			"required", "true");
		AddOrRemoveTag(doc,
			androidNamespaceURI,
