...
public class OVRProjectConfig : ScriptableObject
{
	...
	public enum BodyTrackingSupport
	{
		Disabled = 0,
		Enabled = 1,
	}
	...
	public enum EyeTrackingSupport
	{
		Disabled = 0,
		Enabled = 1,
	}

	public enum TouchControllerProSupport
	{
		Disabled = 0,
		Enabled = 1,
	}
...
#if OVR_INTERNAL_CODE
	public BodyTrackingSupport bodyTrackingSupport = BodyTrackingSupport.Disabled;
	public FaceTrackingSupport faceTrackingSupport = FaceTrackingSupport.Disabled;
	public EyeTrackingSupport eyeTrackingSupport = EyeTrackingSupport.Disabled;
	public TouchControllerProSupport touchControllerProSupport = TouchControllerProSupport.Disabled;
#endif
...
#if OVR_INTERNAL_CODE
			projectConfig.bodyTrackingSupport = BodyTrackingSupport.Disabled;
			projectConfig.trackedKeyboardSupport = TrackedKeyboardSupport.None;
			projectConfig.faceTrackingSupport = FaceTrackingSupport.Disabled;
			projectConfig.eyeTrackingSupport = EyeTrackingSupport.Disabled;
			projectConfig.touchControllerProSupport = TouchControllerProSupport.Disabled;
