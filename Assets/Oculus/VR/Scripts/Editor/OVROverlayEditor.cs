...
public class OVROverlayEditor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		overlay.useEfficientSupersample = EditorGUILayout.Toggle(new GUIContent("Efficient Super Sample",
		...
		overlay.useSharpen = EditorGUILayout.Toggle(new GUIContent("Sharpen",
			"Whether this layer should use a sharpen filter. This amplifies contrast and fine details"), overlay.useSharpen);
#endif
		...
		overlay.overrideBlendFactors = EditorGUILayout.Toggle(new GUIContent("Customize blend mode", "Explicitly specify the blend factors used to composite the overlay."), overlay.overrideBlendFactors);
		if (overlay.overrideBlendFactors) {
			overlay.srcBlendFactor = (OVRPlugin.BlendFactor)EditorGUILayout.EnumPopup(new GUIContent("Src Factor"), overlay.srcBlendFactor);
			overlay.dstBlendFactor = (OVRPlugin.BlendFactor)EditorGUILayout.EnumPopup(new GUIContent("Dst Factor"), overlay.dstBlendFactor);
		}
#endif
