...
public class OVRSkeleton : MonoBehaviour
{
	...
	public struct SkeletonPoseData
	{
		...
		public Vector3 HipsBoneTranslation { get; set; }
#endif
	...
	public enum BoneId
	{
		...
		Body_LeftHandThumbTrapezium      = OVRPlugin.BoneId.Body_LeftHandThumbTrapezium,
		Body_LeftHandThumbMeta           = OVRPlugin.BoneId.Body_LeftHandThumbMeta,
		...
		Body_LeftHandPinkyMeta           = OVRPlugin.BoneId.Body_LeftHandPinkyMeta,
		Body_LeftHandPinkyProximal       = OVRPlugin.BoneId.Body_LeftHandPinkyProximal,
		Body_LeftHandPinkyIntermediate   = OVRPlugin.BoneId.Body_LeftHandPinkyIntermediate,
		Body_LeftHandPinkyDistal         = OVRPlugin.BoneId.Body_LeftHandPinkyDistal,
		Body_RightHandThumbTrapezium     = OVRPlugin.BoneId.Body_RightHandThumbTrapezium,
		Body_RightHandThumbMeta          = OVRPlugin.BoneId.Body_RightHandThumbMeta,
		...
		Body_RightHandPinkyMeta          = OVRPlugin.BoneId.Body_RightHandPinkyMeta,
		Body_RightHandPinkyProximal      = OVRPlugin.BoneId.Body_RightHandPinkyProximal,
		Body_RightHandPinkyIntermediate  = OVRPlugin.BoneId.Body_RightHandPinkyIntermediate,
		Body_RightHandPinkyDistal        = OVRPlugin.BoneId.Body_RightHandPinkyDistal,
			...
			for (var i = 0; i < _bones.Count; ++i)
			{
				if (_bones[i].Transform != null)
				{
					...
					if (_skeletonType == SkeletonType.Body)
					{
						...
						{
							_bones[i].Transform.localPosition = data.HipsBoneTranslation;
						}
					}
					else if (_skeletonType == SkeletonType.HandLeft || _skeletonType == SkeletonType.HandRight)
#else
	...
	public static string BoneLabelFromBoneId(OVRSkeleton.SkeletonType skeletonType, BoneId boneId)
	{
		...
		if (skeletonType == OVRSkeleton.SkeletonType.Body)
		{
			switch (boneId)
			{
				...
				case OVRSkeleton.BoneId.Body_LeftHandThumbTrapezium:
					return "Body_LeftHandThumbTrapezium";
				case OVRSkeleton.BoneId.Body_LeftHandThumbMeta:
					return "Body_LeftHandThumbMeta";
				...
				case OVRSkeleton.BoneId.Body_LeftHandPinkyMeta:
					return "Body_LeftHandPinkyMeta";
				case OVRSkeleton.BoneId.Body_LeftHandPinkyProximal:
					return "Body_LeftHandPinkyProximal";
				case OVRSkeleton.BoneId.Body_LeftHandPinkyIntermediate:
					return "Body_LeftHandPinkyIntermediate";
				case OVRSkeleton.BoneId.Body_LeftHandPinkyDistal:
					return "Body_LeftHandPinkyDistal";
				case OVRSkeleton.BoneId.Body_RightHandThumbTrapezium:
					return "Body_RightHandThumbTrapezium";
				case OVRSkeleton.BoneId.Body_RightHandThumbMeta:
					return "Body_RightHandThumbMeta";
				...
				case OVRSkeleton.BoneId.Body_RightHandPinkyMeta:
					return "Body_RightHandPinkyMeta";
				case OVRSkeleton.BoneId.Body_RightHandPinkyProximal:
					return "Body_RightHandPinkyProximal";
				case OVRSkeleton.BoneId.Body_RightHandPinkyIntermediate:
					return "Body_RightHandPinkyIntermediate";
				case OVRSkeleton.BoneId.Body_RightHandPinkyDistal:
					return "Body_RightHandPinkyDistal";
				default:
					return "Body_Unknown";
			}
		}
