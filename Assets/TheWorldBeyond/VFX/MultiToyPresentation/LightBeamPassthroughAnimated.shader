...
#include "UnityCG.cginc"
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                float FadeoutDistance = clamp(
                        ((distance(_WorldSpaceCameraPos, i.worldPos) - fadeRangeEnd) / (
                            fadeRangeBegin - fadeRangeEnd)),
                        0.0,
                        1.0);
...
#include "UnityCG.cginc"
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                half sinPulse = sin(-_Time.y + i.worldPos.y + col.b) * 0.5 + 0.5;
                sinPulse += sin(-_Time.w + i.worldPos.y + col.g) * 0.5 + 0.5;
                half alpha = col.a * sinPulse * _AdditiveGlowStrength * fresnel * i.vertexColor.r *
                        FadeoutDistance;
