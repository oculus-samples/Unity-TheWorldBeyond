...
namespace TheWorldBeyond.Character
{
    ...
    public class SpaceshipRingLightsEditor : Editor
    {
        ...
        private void Populate(SpaceshipRingLights srl)
        {
            ...
            for (var i = srl.transform.childCount - 1; i > 0; i--) // do not destroy base, index 0
            {
            ...
            for (var i = 1; i < srl.NumLights; i++)
            {
                var l = Instantiate(srl.BaseLight, srl.transform);
    ...
    public class SpaceshipRingLights : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            for (var i = 0; i < m_randomOrder.Length; i++)
            {
        ...
        private void Update()
        {
            ...
            if (m_prevMode != Mode)
            {
                ...
                // m_force lights when switching to dormant
    ...
    public static class RingLightExtensions
    {
        ...
        /// </summary>
        private static System.Random s_rng = new();
